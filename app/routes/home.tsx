    ...
    <div className="mx-auto max-w-4xl px-4 py-12 space-y-20">
      ...
      <section>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          {/* Smart Import */}
          <Link to="/smart-import" className="group flex items-start gap-4 rounded-2xl border border-purple-100 bg-purple-50 p-6 transition-colors hover:bg-purple-100">
            ...
            <div>
              <h3 className="font-semibold text-purple-900">Smart Import</h3>
              <p className="mt-1 text-sm text-purple-700 leading-relaxed">Paste any English text and we'll detect vocabulary worth learning — complete with definitions and phonetics.</p>
            </div>
          </Link>
